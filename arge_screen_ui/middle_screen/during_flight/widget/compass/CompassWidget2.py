...
from PyQt5.QtCore import QObject, pyqtSignal, pyqtSlot, pyqtProperty,QSize,Qt,QPoint
...
class CompassWidget(QtWidgets.QWidget):
    ...
    def compassDegCalculate(self,mag_x,mag_y):
        degrees = math.degrees(math.atan2(mag_y,mag_x))
        if mag_x>0 and mag_y>0:
           degrees = degrees
        elif mag_x>0 and mag_y<0:
           degrees = 90 - degrees
        elif mag_x<0 and mag_y<0:
           degrees = 180 + degrees
        elif mag_x<0 and mag_y>0:
